...
NEW: Prefer using the modular features package for new code:
    from src.transform.features import build_features, get_feature_columns
    
    df = build_features(df.lazy())  # Config-driven, composable features
