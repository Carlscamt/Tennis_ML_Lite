...
class GroupWiseCalibrator:
    ...
    global_calibrator: Optional[ProbabilityCalibrator] = None
    global_platt: Optional[PlattCalibrator] = None
    ...
    def _create_calibrator(self) -> Tuple[Optional[ProbabilityCalibrator], Optional[PlattCalibrator]]:
    ...
    def _apply_calibration(
        self, 
        prob: float, 
        iso_cal: Optional[ProbabilityCalibrator], 
        platt_cal: Optional[PlattCalibrator]
    ) -> float:
